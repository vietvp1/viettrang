    ...
    >
      <div className="page-width">
        ...
        <div className="mt-4 md:mt-10 flex flex-col gap-5 md:gap-7 md:flex-row-reverse md:items-center">
          <div className="text-[14px] md:text-[19px] md:text-left text-center mx-auto scale md:flex-1 md:leading-8z`">
            Cảm ơn bạn đã dành tình cảm cho vợ chồng mình. Chúng mình biết các
            bạn đều đang rất bận, bận với công việc, với cuộc sống và với cả gia
            đình bạn.
            <br />
            Nhưng thực sự sẽ rất tuyệt vời nếu như ngày Hạnh Phúc của chúng mình
            có thêm sự góp mặt của bạn và người thương. Vợ chồng mình rất hi
            vọng sẽ có mặt bạn trong ngày quan trọng này để chứng kiến và chia
            sẽ niềm hạnh phúc này cùng chúng mình.
            <br />
            Một lần nữa, chân thành cảm ơn tất cả các bạn ❤️
          </div>
          <div className="relative h-[252px] md:h-[320px] md:flex-1">
            <Image
              alt=""
