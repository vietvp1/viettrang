  ...
  return (
    <div className="page-width" id="SECTION2">
      <div className="text-center">
        <AnimateOnScroll animationType="fadeInUp" delay={1}>
          <img
        ...
        >
          <AnimateOnScroll>
            <div className="scale-extra hover:text-[#BDA4B3]">Trần Việt</div>
          </AnimateOnScroll>
          <AnimateOnScroll animationType="fadeInDown">&</AnimateOnScroll>
